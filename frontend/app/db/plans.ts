...
export async function getUserProfile(): Promise<UserProfile | null> {
  ...
  return {
    ...
    workout_style: (row.workout_style as UserProfile["workout_style"] | null) ?? "balanced",
...
async function writeUserProfile(
  ...
  await db.run(
    `UPDATE user_profile SET
       ...
       preferred_workout_days_json=?, workout_session_minutes=?, workout_style=?, flex_days_per_week=?,
